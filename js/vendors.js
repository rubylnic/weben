...
const coords = {
  coords: [59.968088, 30.338065],
  name: 'Webenergy',
  description: "Выборгская набережная, 29 ",
};
...
class YmapsInitializer {
  constructor(container, placeCoords = coords) {
      ...
      this.url = 'https://api-maps.yandex.ru/2.1/?lang=ru_RU&amp;apikey=16bde6c3-4e23-4f46-be68-eb04f54a4e88>';
